...
$.extend($.validator, {
	...
	messages: {
		...
		rangelength: $.validator.format("Insira um valor entra {0} e {1}."),
		range: $.validator.format("Insira um valor entre {0} e {1}."),
		max: $.validator.format("Insira um valor no máximo ou igual {0}."),
		min: $.validator.format("Insira um valor no mínimo ou igual {0}.")
	},
