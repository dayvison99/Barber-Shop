					...
					if(response.return){
						...
						$.each(response.dados, function(valor, key){
							...
							if (verificador == 0){
								...
								html +='<ul class="dropdown-menu">';
								html +='<li>';
								html +='<a href="javascript:void(0)" data-toggle="modal" data-target="#modal-default" onclick="pedidos_resumo('+key['id']+')"><i class="fa fa-file-text-o"></i> Resumo</a>';
								html +='</li>';
